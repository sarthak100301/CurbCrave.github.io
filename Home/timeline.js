(window.Modernizr = (function (e, t, n) {
  ...
  function l() {
    (h.input = (function (n) {
      ...
      return (
        L.list &&
          (L.list = !!t.createElement("datalist") && !!e.HTMLDataListElement),
        L
      );
    })(
      ...
      (h.inputtypes = (function (e) {
        for (var r = 0, i, s, o, u = e.length; r < u; r++)
          y.setAttribute("type", (s = e[r])),
            (i = y.type !== "text"),
            i &&
              ((y.value = b),
              (y.style.cssText = "position:absolute;visibility:hidden;"),
              /^range$/.test(s) && y.style.WebkitAppearance !== n
                ? (d.appendChild(y),
                  (o = t.defaultView),
                  (i =
                    o.getComputedStyle &&
                ...
                : /^(search|tel)$/.test(s) ||
                  (/^(url|email)$/.test(s)
                    ? (i = y.checkValidity && y.checkValidity() === !1)
                    : (i = y.value != b))),
            (k[e[r]] = !!i);
        return k;
      })(
  ...
  var c = "2.8.2",
    ...
    _ = function (e, n, r, i) {
      ...
      return (
        ...
        l
          ...
          : (c.parentNode.removeChild(c), (d.style.overflow = a)),
        !!o
      );
    },
    D = function (t) {
      ...
      var r;
      return (
        _("@media " + t + " { #" + v + " { position: absolute; } }", function (
          t
        ) {
          r =
    ...
    H = {}.hasOwnProperty,
    B;
  !s(H, "undefined") && !s(H.call, "undefined")
    ? (B = function (e, t) {
        return H.call(e, t);
      })
    : (B = function (e, t) {
    ...
    (C.rgba = function () {
      return (
        r("background-color:rgba(150,255,150,.5)"), o(g.backgroundColor, "rgba")
      );
    }),
    (C.hsla = function () {
      return (
    ...
    (C.cssgradients = function () {
      var e = "background-image:",
        t = "gradient(linear,left top,right bottom,from(#9f9),to(gray));",
        n = "linear-gradient(left top,#9f9, gray);";
      return (
        r(
          (e + "-webkit- ".split(" ").join(t + e) + E.join(n + e)).slice(
            0,
            -e.length
          )
        ),
    ...
    (C.fontface = function () {
      var e;
      return (
        _('@font-face {font-family:"font";src:url("https://")}', function (
          n,
          r
        ) {
  ...
  for (var j in C)
    B(C, j) &&
      ((M = j.toLowerCase()), (h[M] = C[j]()), A.push((h[M] ? "" : "no-") + M));
  return (
    h.input || l(),
